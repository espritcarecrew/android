...
@Composable
fun BabyListScreen(navController: NavController) {
    // List of milestones with images
    val items = listOf(
        Pair(R.drawable.babylistjpg, "Milestone 1: Smiling wiuerh iwueryheiuw rwiuerg iuwegrui wgruiwegruigweui rgweiug riuewg riuwegr iuwegrweprg wprg weprugewruwgeurgweuruerwurewgyurg"),
        Pair(R.drawable.hhhh2, "Milestone 2: Crawling miling wiuerh iwueryheiuw rwiuerg iuwegrui wgruiwegruigweui rgweiug riuewg riuwegr iuwegrweprg wprg weprugewruwgeurgweuruerwurewgyurg"),
        Pair(R.drawable.babylistjpg, "Milestone 3: Walking miling wiuerh iwueryheiuw rwiuerg iuwegrui wgruiwegruigweui rgweiug riuewg riuwegr iuwegrweprg wprg weprugewruwgeurgweuruerwurewgyurg"),
        Pair(R.drawable.hhhh2, "Milestone 3: Walking miling wiuerh iwueryheiuw rwiuerg iuwegrui wgruiwegruigweui rgweiug riuewg riuwegr iuwegrweprg wprg weprugewruwgeurgweuruerwurewgyurg")
    )
    ...
    Column(
        ...
        TopAppBar(
            title = { Text(text = "Baby Milestones") },
            navigationIcon = {
