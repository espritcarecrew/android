    ...
    fun signUpUser(username: String, email: String, password: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                Log.d("SignUpRequest", "Request Body: username=$username, email=$email, password=$password")

                // Make the sign-up request
                val response: Response<SignUpResponse> = userRepository.signUp(username, email, password)
